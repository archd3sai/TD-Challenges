...
workshop_data = pd.read_csv("data/workshops.csv")
query_data = pd.read_csv("data/queries.csv")
...
def find_best_result(query):
        ...
        return arrange_results(tag_similarity(query), name_similarity_index(query))
